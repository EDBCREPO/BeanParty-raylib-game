...
Module['FS_createPath']("/assets/models", "characters", true, true);
Module['FS_createPath']("/assets/models", "environment", true, true);
...
var ASM_CONSTS = {
  518688: function($0, $1) {var value = UTF8ToString($1); var key = UTF8ToString($0); window[key] = value; return 1;},  
 518781: function($0, $1) {stringToUTF8( window[key], $0, $1 ); return str.length;},  
 518841: function($0) {var key = UTF8ToString($0); delete window[key]; return 1;}
};
...
function GetWindowInnerWidth(){ return window.innerWidth; }
  ...
  function ___syscall_chdir(path) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(2, 1, path);
  ...
  function ___syscall_faccessat(dirfd, path, amode, flags) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(3, 1, dirfd, path, amode, flags);
  ...
  function _emscripten_get_element_css_size(target, width, height) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(8, 1, target, width, height);
  ...
  function _emscripten_get_gamepad_status(index, gamepadState) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(9, 1, index, gamepadState);
  ...
  function _emscripten_get_num_gamepads() {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(10, 1);
  ...
  function _emscripten_request_pointerlock(target, deferUntilInEventHandler) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(11, 1, target, deferUntilInEventHandler);
  ...
  function _emscripten_sample_gamepad_data() {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(12, 1);
  ...
  function _emscripten_set_canvas_element_size_main_thread(target, width, height) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(13, 1, target, width, height);
  ...
  function _emscripten_set_click_callback_on_thread(target, userData, useCapture, callbackfunc, targetThread) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(14, 1, target, userData, useCapture, callbackfunc, targetThread);
  ...
  function _emscripten_set_fullscreenchange_callback_on_thread(target, userData, useCapture, callbackfunc, targetThread) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(15, 1, target, userData, useCapture, callbackfunc, targetThread);
  ...
  function _emscripten_set_gamepadconnected_callback_on_thread(userData, useCapture, callbackfunc, targetThread) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(16, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  function _emscripten_set_gamepaddisconnected_callback_on_thread(userData, useCapture, callbackfunc, targetThread) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(17, 1, userData, useCapture, callbackfunc, targetThread);
  ...
  function _emscripten_websocket_delete(socketId) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(24, 1, socketId);
  ...
  function _emscripten_websocket_get_ready_state(socketId, readyState) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(25, 1, socketId, readyState);
  ...
  function _fd_close(fd) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(32, 1, fd);
  ...
  function _fd_seek(fd, offset_low, offset_high, whence, newOffset) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(34, 1, fd, offset_low, offset_high, whence, newOffset);
  ...
  function _fd_write(fd, iov, iovcnt, pnum) {
    if (ENVIRONMENT_IS_PTHREAD)
      return _emscripten_proxy_to_main_thread_js(35, 1, fd, iov, iovcnt, pnum);
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 511356;
var __emscripten_allow_main_runtime_queued_calls = Module['__emscripten_allow_main_runtime_queued_calls'] = 518228;
